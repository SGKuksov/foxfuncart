...
gulp.task('js', function () {
  return gulp.src([
      ...
      // 'assets/js/slick/slick.min.js',                // подключение slick
      // 'assets/js/easytabs/jquery.easytabs.min.js',   // подключение easytabs
      // 'assets/js/waypoints/jquery.waypoints.min.js', // подключение waypoint
      'assets/js/main.js',                               // подключение main
      'assets/js/global.js'                               // подключение global
    ])
